...
router.post('/login', async(req, res)=>{if(db.login(req.body.usuario, req.body.password)){req.session.usuario = req.body.usuario; res.redirect('/../app/index.html')}else{res.redirect(`?${req.usuario}`)}})
